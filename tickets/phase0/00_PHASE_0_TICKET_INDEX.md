...
| 順序 | 番号 | タイトル | 主な依存 | 状態 |
|---:|---|---|---|---|
| 1 | [P0-001](P0-001_REPOSITORY_RULES.md) | リポジトリ規約・Build番号・品質ゲート確定 | なし | 完了・レビュー待ち |
| 2 | [P0-002](P0-002_HOSTING_PLATFORM_BOUNDARY_POC.md) | Server起動方式とWindows依存境界PoC | P0-001 | 未着手 |
